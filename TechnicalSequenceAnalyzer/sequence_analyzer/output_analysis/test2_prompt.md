...
- **Enseignant** (entity): Accès aux données
- **UI** (boundary): Interface utilisateur
- **Controleur** (controller): Orchestrateur de la logique métier
- **Table_Salle** (entity): Accès aux données
- **Table_PC** (entity): Accès aux données
- **Table_Projecteur** (entity): Accès aux données
- **Utilisateur** (entity): Accès aux données
- **Reservation** (entity): Accès aux données
