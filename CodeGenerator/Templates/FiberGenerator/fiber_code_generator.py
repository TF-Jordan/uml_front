...
# Correspondance type JSON -> Go moderne
TYPE_MAP = {
    "int": "int",
    "integer": "int",
    "long": "int64",
...
class FiberCodeGenerator:
    ...
    def generate_project(self, project_name: str, project_payload: Dict[str, Any]) -> None:
        ...
        self._render_template("main.go.j2", project_dir / "main.go", project_name=project_name)

        self._render_template("go.mod.j2", project_dir / "go.mod", project_name=project_name)
